...
# -----------------------------------------------------------------------------
# QIIME2 UNITE database files (generated by Unite_build_db.sh)
#
...
# The QIIME2 UNITE database files must be generated beforehand using Unite_build_db.sh
# This script does NOT build or download any database files.
...
UNITE_DIR="/data/splaisan/biodata/qiime2_ITS"
OUTPUT_DIR="$(pwd)"
